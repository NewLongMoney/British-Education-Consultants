...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-full text-sm font-semibold ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        default:
          "bg-gradient-to-r from-brand-red to-rose-500 text-white shadow-lg shadow-brand-red/30 hover:shadow-xl hover:shadow-brand-red/40 hover:-translate-y-0.5",
        secondary:
          "bg-white text-brand-blue border-2 border-slate-200 hover:border-brand-blue hover:bg-brand-blue hover:text-white",
        outline:
          "border-2 border-brand-blue text-brand-blue hover:bg-brand-blue hover:text-white",
        ghost: "hover:bg-slate-100 hover:text-brand-blue",
